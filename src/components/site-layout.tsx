...
import logoSrc from "@/assets/smart-irrigation-logo.png";
    ...
    <div className="min-h-screen bg-background text-foreground">
      <header className="sticky top-0 z-50 border-b border-primary/10 bg-background/95 backdrop-blur-lg">
        <div className="mx-auto grid h-20 max-w-7xl grid-cols-[minmax(0,1fr)_auto] items-center gap-4 px-5 sm:px-8">
          <Link to="/" className="flex min-w-0 items-center" onClick={() => setOpen(false)} aria-label="Smart Irrigation home">
            <img src={logoSrc} width={1180} height={159} alt="Smart Irrigation Design & Consulting" className="h-auto w-48 max-w-full sm:w-60" />
          </Link>
      ...
      <footer className="bg-primary px-5 py-14 text-primary-foreground sm:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 md:grid-cols-3">
          ...
          <div><p className="text-[10px] font-bold uppercase tracking-[0.22em] text-accent">Contact</p><a className="mt-4 block text-lg" href="tel:+919494230489">+91 94942 30489</a><a className="mt-2 block text-sm text-primary-foreground/85" href="mailto:smartirrigationdis21@gmail.com">smartirrigationdis21@gmail.com</a><a className="mt-1 block text-sm text-primary-foreground/85" href="mailto:admin@smartirrigationdis21.in">admin@smartirrigationdis21.in</a></div>
